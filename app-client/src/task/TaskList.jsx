...
import { getAllTasks, getUserCreatedTasks, getOtherTask } from '../util/APIUtils';
...
class TaskList extends Component {
    constructor(props) {
        ...
        this.loadPollList = this.loadTaskList.bind(this);
    ...
    loadTaskList(page = 0, size = TASK_LIST_SIZE) {
        ...
        if(this.props.username) {
            if(this.props.type === 'USER_CREATED_TASK') {
                promise = getUserCreatedTasks(this.props.username, page, size);
            } else if (this.props.type === 'OTHER_TASK') {
                promise = getOtherTask(this.props.username, page, size);                               
            }
        } else {
